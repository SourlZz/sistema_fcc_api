...
class Materias(models.Model):
    id = models.BigAutoField(primary_key=True)
    nrc = models.CharField(max_length=100, unique=True, null=True) 
    nombre = models.CharField(max_length=100, blank=True, null=False)
    seccion = models.CharField(max_length=10, blank=True, null=False)
    dias_json = models.CharField(max_length=255, blank=True)  # Puedes cambiar el tipo de campo según necesites
    hora_inicio = models.CharField(max_length=255, blank=True, null=False)
    hora_fin = models.CharField(max_length=255, blank=True)
    salon = models.CharField(max_length=50, blank=False, null=False)
    programa = models.CharField(max_length=100, blank=False, null=False)  # Puedes cambiar el tipo de campo según necesites
    creation = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    update = models.DateTimeField(null=True, blank=True)
